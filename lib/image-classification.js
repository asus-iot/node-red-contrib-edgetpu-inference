module.exports = function (RED) {
	...
	console.log('Locker >> image class');
        var self = this;
...
def init_config():
    if CFG_TPUTYPE == 1:
        ...
        engine = ClassificationEngine(CFG_MODEL[1:], tpu_usb[int(CFG_TPUNUM)])
    else:
        engine = ClassificationEngine(CFG_MODEL[1:], "/dev/apex_" + CFG_TPUNUM[1:])
