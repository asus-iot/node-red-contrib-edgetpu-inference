...
@import url('http://${ip}:1880/node_modules/node-red-contrib-edgetpu-inference/lib/result_tab_horizontal.css') screen and (max-width: 1024px);
@import url('http://${ip}:1880/node_modules/node-red-contrib-edgetpu-inference/lib/result_tab_vertical.css') screen and (min-width: 376px) and (max-width: 768px);
@import url('http://${ip}:1880/node_modules/node-red-contrib-edgetpu-inference/lib/result_mobile_vertical.css') screen and (max-width : 375px);
