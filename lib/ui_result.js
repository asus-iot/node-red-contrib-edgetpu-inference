...
@import url('http://localhost:1880/node_modules/node-red-contrib-edgetpu-inference/lib/result_normal.css');
@import url('http://localhost:1880/node_modules/node-red-contrib-edgetpu-inference/lib/result_tab_horizontal.css') screen and (max-width: 1024px);
@import url('http://localhost:1880/node_modules/node-red-contrib-edgetpu-inference/lib/result_tab_vertical.css') screen and (max-width: 768px);
@import url('http://localhost:1880/node_modules/node-red-contrib-edgetpu-inference/lib/result_mobile_vertical.css') screen and (max-width : 375px);
