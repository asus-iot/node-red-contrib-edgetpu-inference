...
@import url('http://${ip}:1880/node_modules/node-red-contrib-edgetpu-inference/lib/result_tab_horizontal.css') screen and (min-width: 960px) and (max-width: 1366px);
@import url('http://${ip}:1880/node_modules/node-red-contrib-edgetpu-inference/lib/result_tab_vertical.css') screen and (min-width: 751px) and (max-width: 959px);
@import url('http://${ip}:1880/node_modules/node-red-contrib-edgetpu-inference/lib/result_mobile_vertical.css') screen and (max-width : 750px);
