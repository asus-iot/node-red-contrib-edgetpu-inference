...
.bg_p {
  ...
  background-image: linear-gradient(to top, #59ceb7, #58adbd, #4b87ce, #2e5fa8);
  display: grid;
...
<img src="http://localhost:1880/node_modules/node-red-contrib-edge-tpu/lib/img/performance-bg-down-pic.png" class="performance_bg_down_pic">
<div class='Performance-Node'>Performance Node</div>
<img src="http://localhost:1880/node_modules/node-red-contrib-edge-tpu/lib/img/performance-bg-up-pic.png" class="performance_bg_up_pic">
<img src="http://localhost:1880/node_modules/node-red-contrib-edge-tpu/lib/img/ic-cpu.png" class="ic_cpu">
<img src="http://localhost:1880/node_modules/node-red-contrib-edge-tpu/lib/img/ic-ram.png" class="ic_ram">
<img src="http://localhost:1880/node_modules/node-red-contrib-edge-tpu/lib/img/ic-tpu.png" class="ic_tpu">
...
<div class='cpu_info'>
  ...
  <div class='info_left'>
    ...
    <div class='cpu_bar_bg'>
      <img src="http://localhost:1880/node_modules/node-red-contrib-edge-tpu/lib/img/bar.png" class="bar_mask">
    </div>
...
<div class='tpu_info'>
  <div class='info_header'>
    ...
    <md-button ng-click="click_A()">
      <img src="http://localhost:1880/node_modules/node-red-contrib-edge-tpu/lib/img/btn-left-able.png" class="btn_left_able">
    </md-button>

    <md-button ng-click="click_B()">
      <img src="http://localhost:1880/node_modules/node-red-contrib-edge-tpu/lib/img/btn-right-able.png" class="btn_right_able">
    </md-button>
  </div>
  ...
  <div class='tpu_right'>
    <div class='tpu_bar_bg'>
      <img src="http://localhost:1880/node_modules/node-red-contrib-edge-tpu/lib/img/bar-blue.png" class="tpu_bar_mask">
    </div>
    <div class='tpu_bar_bg'>
      <img src="http://localhost:1880/node_modules/node-red-contrib-edge-tpu/lib/img/bar-blue.png" class="tpu_bar_mask">
    </div>
