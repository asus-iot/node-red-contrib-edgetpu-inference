...
@import url('http://localhost:1880/node_modules/node-red-contrib-edgetpu-inference/lib/performance_tab_vertical.css') screen and (min-width: 376px) and (max-width: 768px);
            ...
            if (checkConfig(node, config)) {
                ...
                var html = HTML(config);
                    ...
                    initController: function($scope) {
                        ...
                        function set_tpu_info_375_flag0(msg,tpuID){
                          var tmpA = msg.tmpA
                          var tmpB = msg.tmpB
                          var tmp_all = tmpA.concat(tmpB);
                          var tpu_label =[0,1,2,3,4];
                        ...
                        function set_tpu_info_768_flag0(msg,tpuID){
                          var tmpA = msg.tmpA
                          var tmpB = msg.tmpB
                          var tmp_all = tmpA.concat(tmpB);
