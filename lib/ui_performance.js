module.exports = function(RED) {
    ...
    function HTML(config) {
        ...
        <p id="CPU_usage_{{$id}}"><font face="monospace" size ="4">CPU:{{msg.cpu}}%</font></p>
        <canvas id="CPU_{{$id}}" width="500" height="300"></canvas>
        <p id="RAM_usage_{{$id}}"><font face="monospace" size ="4">RAM:{{msg.ram}}%</font></p>
                    ...
                    initController: function($scope) {
                        ...
                        function draw_tpu(msg){
                            ...
                            var myChart = new Chart(chart, {
                                type: 'bar',
                                data: {
                                labels: ["TPU0", "TPU1", "TPU2", "TPU3", "TPU4", 'TPU5','TPU6','TPU7','TPU8','TPU9','TPU10','TPU11','TPU12','TPU13','TPU14','TPU15'],
                                datasets: [{
                                    label: "TPU",
                                    fill: false,
                                    lineTension: 0,
                        ...
                        function draw_cpu(data){
                            var ctx_cpu = document.querySelector("canvas#CPU_"+$scope.$id).getContext('2d');
                            var chart_cpu = new Chart(ctx_cpu, {
                              type: 'line',
                              data: {
                                labels: ['60s','','','','','','','','','','','','','','','','','','','',
                                         '','','','','','','','','','','','','','','','','','','','',
